			...
			<div className="relative mx-auto w-full max-w-6xl px-5 pt-6 pb-10 sm:pt-10 sm:pb-16 md:px-8 md:pt-14 md:pb-24 lg:px-12 lg:pt-16 lg:pb-28">
				<div className="grid items-center gap-4 sm:gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:gap-8">
					...
					<div className="order-2 flex flex-col items-center text-center lg:order-1 lg:items-start lg:text-left">
						{/* Date & venue */}
						<div className="mb-3 flex flex-col items-center gap-1.5 sm:mb-6 sm:flex-row sm:gap-4 md:mb-8 lg:justify-start">
							<div className="flex shrink-0 items-center gap-1.5 whitespace-nowrap sm:gap-2">
								...
								<span className="text-[11px] font-semibold tracking-wide text-white sm:text-sm md:text-base">
									March 21, 2026
								</span>
							</div>
							<div className="flex shrink-0 items-center gap-1.5 whitespace-nowrap sm:gap-2">
								<IconMapPin className="h-3.5 w-3.5 text-secondary/80 sm:h-4 sm:w-4" />
								<span className="text-[11px] font-medium text-white/60 sm:text-sm md:text-base">
						...
						{/* Subtitle */}
						<p className="mb-5 max-w-[32ch] text-xs leading-relaxed text-white/50 sm:mb-8 sm:max-w-lg sm:text-sm md:mb-10 md:text-base lg:text-lg">
						...
						{/* CTA buttons */}
						<div className="flex w-full flex-col items-center gap-2.5 sm:w-auto sm:flex-row sm:gap-4 lg:justify-start">
							<Link
								href="#partners"
								className="inline-flex w-full items-center justify-center rounded-full bg-primary/90 px-5 py-2.5 text-[11px] font-semibold uppercase tracking-wide text-white transition-all hover:bg-primary sm:w-auto sm:px-8 sm:py-3 sm:text-sm lg:px-10 lg:py-4"
							>
								Partner With Us
							</Link>
							<Link
								href="#merch"
								className="inline-flex w-full items-center justify-center rounded-full border border-white/[0.08] px-5 py-2.5 text-[11px] font-semibold uppercase tracking-wide text-white/80 transition-all hover:border-white/20 hover:text-white sm:w-auto sm:px-8 sm:py-3 sm:text-sm lg:px-10 lg:py-4"
							>
