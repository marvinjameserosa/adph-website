...
const Location = () => {
	...
	return (
		<div className="container grid w-full grid-cols-1 items-center justify-between gap-6 md:grid-cols-2 md:gap-10 lg:gap-12">
			<div className="text-center md:text-left">
				<h2>
					Venue is at <span className="text-secondary">{venueName}</span>
				</h2>
				<p className="mt-3 text-sm sm:text-base md:text-xl">
					Join us at {venueName}. Full address details and onsite logistics will be shared closer to the event.
				</p>
			</div>
			<div className="rounded-3xl border border-white/10 bg-[#0d0f17] px-4 py-8 shadow-[0_20px_60px_rgba(0,0,0,0.35)] sm:px-6 sm:py-10">
				<div className="flex flex-col items-center gap-3 text-center">
					<p className="text-xs uppercase tracking-[0.22em] text-white/60">Location</p>
					<p className="text-xl font-semibold sm:text-2xl">{venueName}</p>
